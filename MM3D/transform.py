...
# from https://gist.github.com/nh2/bc4e2981b0e213fefd4aaa33edfb3893
def estimate_rigid_matrix_3d23d(P, Q):
    P = P.copy()
    Q = Q.copy()
    # P: src ;  Q: des
...
def estimate_affine_matrix_3d23d(A, B):
    '''
